...
/* -@- */
#if 1
#define BSP_USART_Receive
#if 1
#define BSP_USART_VariableReceive
#endif
#endif
#if 1
#define BSP_USART_Transmit 3
#if 1
#define BSP_USE_PRINTF
#endif /* ！BSP_USE_PRINTF */
...
/* printf function handle */
#define USART_HANDLE_PRF huart3

/* bsprifx function handle */
#if BSP_USART_Transmit >= 1
#define USART_HANDLE_PRF1 huart1
#if BSP_USART_Transmit >= 2
#define USART_HANDLE_PRF2 huart2
#if BSP_USART_Transmit >= 3
