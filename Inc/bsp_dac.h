...
#define __Lisaru_Draw_Num(n)                                                                       \
	{                                                                                              \
		HAL_DAC_SetValue(&hdac, DAC1_CHANNEL_1, DAC_ALIGN_12B_R, lisaru_Num[n]->x[lisaru_counts]); \
		HAL_DAC_SetValue(&hdac, DAC1_CHANNEL_2, DAC_ALIGN_12B_R, lisaru_Num[n]->y[lisaru_counts]); \
		lisaru_counts++;                                                                           \
		if (lisaru_counts >= lisaru_Num[n]->len)                                                   \
			lisaru_counts = 0;                                                                     \
	}
#define __Lisaru_Draw_Alp(n)                                                                       \
	{                                                                                              \
		HAL_DAC_SetValue(&hdac, DAC1_CHANNEL_1, DAC_ALIGN_12B_R, lisaru_Alp[n]->x[lisaru_counts]); \
		HAL_DAC_SetValue(&hdac, DAC1_CHANNEL_2, DAC_ALIGN_12B_R, lisaru_Alp[n]->y[lisaru_counts]); \
		lisaru_counts++;                                                                           \
		if (lisaru_counts >= lisaru_Alp[n]->len)                                                   \
			lisaru_counts = 0;                                                                     \
	}
#endif /* LisaruImage */
