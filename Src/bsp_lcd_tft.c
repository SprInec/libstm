...
/**
 * @brief BGR转RGB
 * @details 从ILI93xx读出的数据为GBR格式，而我们写入的时候为RGB格式
 * @param c GBR格式的颜色值
 ...
 * @attention 他函数可能会受到此函数设置的影响(尤其是9341/6804这两个奇葩)
 ...
 * @param width 窗口宽度<必须大于0>
 * @param height 窗口高度<必须大于0>
 * @attention 68042横屏时不支持窗口设置
 */
...
/**
 * @brief 在指定区域内填充单个颜色
 * @attention 区域大小:(ex-sx+1)*(ey-sy+1)
 * @param sx 填充矩形对标坐标x1
 * @param sy 填充矩形对角坐标y1
 * @param ex 填充矩形对角坐标x2
 * @param ey 填充矩形对角坐标y2
